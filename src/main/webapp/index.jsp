...
<html lang="en">
  ...
  <head>
    ...
    <title>this is my search engine</title>
  <link href="<c:url value="resources/css/style1.css"/>">
  <script src="<c:url  value="resources/js/script.js">    </c:url>">    </script>
  </head>
  <body>
  <img alt="my image" src='<c:url value="resources/image/good.jpg"></c:url>'>
 
 <h1>hii  iam use externl css</h1>
 			...
 			<h3 class="text-center text-white text-uppercase">my search </h3>.
 				<form action="search" class="mt-5" >
 					<div class="form-group">
 						<input type="text" name="runquery" placeholder="enter your keyword"class="form-control"/>
